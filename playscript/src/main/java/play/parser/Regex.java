...
public class Regex {
     ...
     * @return
     */
    protected static boolean matchWithNFA(State state, String str) {
    ...
    protected static boolean matchWithDFA(DFAState state, String str) {
     ...
     * @return
     */
    protected static boolean matchWithDFA(DFAState state, char[] chars, int index) {
    ...
    /**
     * 创建一个示例用的正则表达式： int | [a-zA-z][a-zA-Z0-9]* | [0-9]*
     *
     * @return
     */
     ...
     * @return
     */
    protected static GrammarNode sampleGrammar2() {
