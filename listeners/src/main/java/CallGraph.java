...
public class CallGraph {
    ...
    /**
     * A graph model of the output. Tracks call from one function to another by mapping function to list of called
     * functions. E.g., f -> [g, h] Can dump DOT two ways (StringBuilder and ST). Sample output: digraph G { ... setup
     * ... f -> g; g -> f; g -> h; h -> h; }
     */
    static class Graph {
        ...
        /**
         * Fill StringTemplate: digraph G { rankdir=LR; <edgePairs:{edge| <edge.a> -> <edge.b>;}; separator="\n">
    ...
    static class FunctionListener extends CymbolBaseListener {
        ...
        public void enterFunctionDecl(CymbolParser.FunctionDeclContext ctx) {
            System.out.println("enterFunctionDecl: " + ctx.ID().getText());
            currentFunctionName = ctx.ID().getText();
            graph.nodes.add(currentFunctionName);
        }

        public void exitCall(CymbolParser.CallContext ctx) {
            System.out.println("exitCall: " + ctx.ID().getText());
