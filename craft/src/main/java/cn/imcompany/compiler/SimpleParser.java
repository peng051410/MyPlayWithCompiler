...
public class SimpleParser {
    ...
    String dumpASTV2(ASTNode node, String indent, StringBuilder sb) {

        sb.append(indent + node.getType() + " " + node.getText()).append("\n");
        for (ASTNode child : node.getChildren()) {
            dumpASTV2(child, indent + "\t", sb);
        }
        return sb.toString();
    }
}